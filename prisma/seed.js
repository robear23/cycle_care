...
const messages = [
    // Menstrual
    { phase: 'menstrual', message_text: "[Partner] is in their period — this can be physically draining and uncomfortable. Take something off their plate today without being asked. Even making tea, handling a chore, or just being quiet company matters more than you think." },
    ...
    // Ovulation
    { phase: 'ovulation', message_text: "[Partner] is likely around ovulation — confidence and social energy are often at their peak. Tell them something specific you genuinely admire about them today." },
    ...
    { phase: 'luteal', message_text: "[Partner] may be craving comfort right now — their favourite meal, a low-key evening, or just sitting together without your phone." },

    // General
    { phase: 'general', message_text: "Make [Partner] feel special today with a heartfelt, specific compliment." },
    { phase: 'general', message_text: "Surprise [Partner] with a small gesture — a note, a text, their favourite coffee." }
];
